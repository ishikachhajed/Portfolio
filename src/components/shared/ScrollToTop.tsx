...
export const ScrollToTop: React.FC = () => {
  ...
  return (
    ...
    >
      <motion.div
        style={{ pointerEvents: "none", display: "flex", alignItems: "center", justifyContent: "center", width: 42, height: 42, backgroundColor: "var(--brand)", color: "black", borderRadius: "50%", boxShadow: "0 0 10px rgba(34, 211, 238, 0.4)" }}
        initial={{ y: 0 }}
        animate={
